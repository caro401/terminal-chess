...
class Board:
    def __init__(self, axes: bool) -> None:
        self.board: BoardList = [[WR, WN, WB, WQ, WK, WB, WN, WR], [WP] * 8, [None] * 8, [None] * 8,
        ...
        if move_str:
            ...
            if move:
                ...
                if self.white_move and (self.board[origin[0]][origin[1]] not in WHITE_PIECES):
                    ...
                    valid_moves: Set[Coordinates] = self.get_valid_moves(origin[0], origin[1])
    ...
    def display_valid_moves(self, row: int, col: int) -> None:
        moves_set: Set[Coordinates] = self.get_valid_moves(row, col)
        show: BoardList = copy.deepcopy(self.board)
